...
/**
 * Created by Benjamin DANGLOT benjamin.danglot@inria.fr on 14/12/17
 */
public class JUnit4Runner {
	...
	public static void main(String[] args) {
		...
		JUnit4Runner.run(options.getFullQualifiedNameOfTestClassesToRun(), options.getTestMethodNamesToRun(),
				options.getBlackList(), jUnit4TestResult, JUnit4Runner.class.getClassLoader());
	 ...
	 */
	public static void run(String[] testClassNames, String[] testMethodNames, List<String> blackList,
			JUnit4TestResult listener, ClassLoader customClassLoader) {
		Request request;
