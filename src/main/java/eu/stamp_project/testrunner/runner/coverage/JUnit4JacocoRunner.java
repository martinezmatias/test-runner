...
public class JUnit4JacocoRunner extends JacocoRunner {
	...
	public static void main(String[] args) {
		...
		final JacocoRunner jacocoRunner = new JUnit4JacocoRunner(classesDirectory, testClassesDirectory,
	...
	protected Coverage executeTest(String[] testClassNames, String[] testMethodNames, List<String> blackList) {
		...
		JUnit4Runner.run(testClassNames, testMethodNames, blackList, (JUnit4TestResult) listener,
