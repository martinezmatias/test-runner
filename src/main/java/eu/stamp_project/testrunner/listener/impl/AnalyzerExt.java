...
/**
 * An {@link AnalyzerExt} instance processes a set of Java class files and
 ...
 * {@link AnalyzerExt} requires a {@link ExecutionDataStore} instance that holds
 * the execution data for the classes to analyze. The {@link AnalyzerExt} offers
 * several methods to analyze classes from a variety of sources.
 */
public class AnalyzerExt {
...
//	private final ICoverageVisitor coverageVisitor;
	 ...
	 *                        analyzed class
	 */
	public AnalyzerExt(final ExecutionDataStore executionData) {
	...
	private ClassVisitor createAnalyzingVisitor(final long classid, final String className) {
		...
		final ClassAnalyzerExt analyzer = new ClassAnalyzerExt(coverage, probes, stringPool) {
	...
	public void analyzeClass(final ClassReader reader) {
		final ClassVisitor visitor = createAnalyzingVisitor(CRC64.checksum(reader.b), reader.getClassName());
