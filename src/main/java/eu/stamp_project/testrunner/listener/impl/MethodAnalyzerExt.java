 ...
 */
public class MethodAnalyzerExt extends MethodProbesVisitor {
...
//	private final MethodCoverageImpl coverage;
	 ...
	 * 
	 * @param probes    recorded probe date of the containing class or
	 *                  <code>null</code> if the class is not executed at all
	 */
	public MethodAnalyzerExt(final String name, final String desc, final String signature, final boolean[] probes) {
		super();
		this.probes = probes;
...
//	}
	...
	@Override
	public void visitTableSwitchInsnWithProbes(final int min, final int max, final Label dflt, final Label[] labels,
			final IFrame frame) {
	...
	private void visitSwitchInsnWithProbes(final Label dflt, final Label[] labels) {
		visitInsn();
...
//			final ICounter branchCounter = total > 1 ? CounterImpl.getInstance(total - covered, covered)
