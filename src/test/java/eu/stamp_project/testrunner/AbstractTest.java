...
public class AbstractTest {
	...
	public static void beforeClass() throws Exception {
		...
		testClasses.mkdir();
		String jvhome = (System.getProperty("java.home")) + File.separator + "bin";
		// compiling
		String command = "/Library/Java/JavaVirtualMachines/jdk1.8.0_101.jdk/Contents/Home/bin/javac -d src/test/resources/test-projects/target/classes "
		...
		command = "/Library/Java/JavaVirtualMachines/jdk1.8.0_101.jdk/Contents/Home/bin/javac -d src/test/resources/test-projects/target/test-classes"
				+ " -cp src/test/resources/test-projects/target/classes/" + ConstantsHelper.PATH_SEPARATOR + JUNIT_CP
				+ ConstantsHelper.PATH_SEPARATOR + EASYMOCK_CP + ConstantsHelper.PATH_SEPARATOR + JUNIT5_CP
	...
	public static final String MAVEN_HOME = Arrays
			.stream(((URLClassLoader) URLClassLoader.getSystemClassLoader()).getURLs()).map(URL::getPath)
			.filter(path -> path.contains("/.m2/repository/")).findFirst()
			.map(s -> s.substring(0, s.indexOf("/.m2/repository/") + "/.m2/repository/".length())).get();

	public static final String TEST_PROJECT_CLASSES = "src/test/resources/test-projects/target/classes/"
			+ ConstantsHelper.PATH_SEPARATOR + "src/test/resources/test-projects/target/test-classes/";

	public static final String JUNIT_CP = MAVEN_HOME + "junit/junit/4.12/junit-4.12.jar"
			+ ConstantsHelper.PATH_SEPARATOR + MAVEN_HOME + "org/hamcrest/hamcrest-core/1.3/hamcrest-core-1.3.jar";

	public static final String EASYMOCK_CP = MAVEN_HOME + "org/easymock/easymock/3.4/easymock-3.4.jar"
			+ ConstantsHelper.PATH_SEPARATOR + MAVEN_HOME + "org/objenesis/objenesis/2.2/objenesis-2.2.jar";

	public static final String JUNIT5_CP = MAVEN_HOME
			+ "org/junit/jupiter/junit-jupiter-api/5.3.2/junit-jupiter-api-5.3.2.jar" + ConstantsHelper.PATH_SEPARATOR
			+ MAVEN_HOME + "org/apiguardian/apiguardian-api/1.0.0/apiguardian-api-1.0.0.jar"
			+ ConstantsHelper.PATH_SEPARATOR + MAVEN_HOME + "org/opentest4j/opentest4j/1.1.1/opentest4j-1.1.1.jar"
			+ ConstantsHelper.PATH_SEPARATOR + MAVEN_HOME
			...
			+ ConstantsHelper.PATH_SEPARATOR + MAVEN_HOME
			+ "org/junit/jupiter/junit-jupiter-params/5.3.2/junit-jupiter-params-5.3.2.jar"
			+ ConstantsHelper.PATH_SEPARATOR + MAVEN_HOME
